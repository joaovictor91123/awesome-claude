...
category: hooks
description: >-
  Automated security vulnerability scanning that integrates with development
  workflow to detect and prevent security issues before deployment.
cardDescription: >-
  Automated security vulnerability scanning that integrates with development
  workflow to detect and prevent security issues before deployment.
...
seoDescription: >-
  Automated security vulnerability scanning that integrates with development
  workflow to detect and prevent security issues before deployment. This
  PostToolUse...
author: JSONbored
...
installable: true
installCommand: >-
  mkdir -p .claude/hooks && touch .claude/hooks/security-scanner-hook.sh &&
  chmod +x .claude/hooks/security-scanner-hook.sh
usageSnippet: >-
  mkdir -p .claude/hooks && touch .claude/hooks/security-scanner-hook.sh &&
  chmod +x .claude/hooks/security-scanner-hook.sh
copySnippet: |-
