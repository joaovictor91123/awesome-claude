...
installCommand: >-
  ...
  .claude/hooks/documentation-auto-generator-on-stop.sh && chmod +x
  .claude/hooks/documentation-auto-generator-on-stop.sh
usageSnippet: >-
  mkdir -p .claude/hooks && touch
  .claude/hooks/documentation-auto-generator-on-stop.sh && chmod +x
  .claude/hooks/documentation-auto-generator-on-stop.sh
