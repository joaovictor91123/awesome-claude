...
cardDescription: Scans for potential sensitive data exposure and alerts immediately.
seoTitle: Sensitive Data Alert Scanner - Hooks
seoDescription: >-
  Scans for potential sensitive data exposure and alerts immediately. This
  Notification hook provides comprehensive sensitive data detection with
  real-time sen...
author: JSONbored
...
installable: true
installCommand: >-
  mkdir -p .claude/hooks && touch .claude/hooks/sensitive-data-alert-scanner.sh
  && chmod +x .claude/hooks/sensitive-data-alert-scanner.sh
usageSnippet: >-
  mkdir -p .claude/hooks && touch .claude/hooks/sensitive-data-alert-scanner.sh
  && chmod +x .claude/hooks/sensitive-data-alert-scanner.sh
copySnippet: |-
