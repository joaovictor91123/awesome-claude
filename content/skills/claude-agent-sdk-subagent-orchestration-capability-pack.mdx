---
title: Claude Agent SDK Subagent Orchestration Capability Pack Skill
slug: claude-agent-sdk-subagent-orchestration-capability-pack
category: skills
description: >-
...
cardDescription: >-
  Review and operationalize Agent SDK subagent orchestration with source-backed Claude Code checklists.
seoTitle: Claude Agent SDK Subagent Orchestration Capability Pack Skill
seoDescription: >-
  Source-backed capability pack for Agent SDK subagent orchestration: workflow steps, review matrix, troubleshooting, and rollout notes aligned to official Claude Code documentation.
author: kiannidev
...
sourceSubmissionNumber: 1509
sourceSubmissionUrl: "https://github.com/JSONbored/awesome-claude/issues/1509"
repoUrl: "https://github.com/anthropics/claude-code"
documentationUrl: "https://github.com/anthropics/claude-code"
downloadUrl: "https://github.com/anthropics/claude-code/archive/refs/heads/main.zip"
installable: false
usageSnippet: >-
  Use this skill when planning or hardening Agent SDK subagent orchestration in Claude Code, Agent SDK, or MCP integrations.
copySnippet: |-
  # Trigger
...
tags:
  ...
  - capability-pack
keywords:
  - "Claude Agent SDK subagent orchestration capability pack"
  - "Claude Code Agent SDK subagent orchestration"
  - "Agent SDK subagent orchestration review checklist"
  - "Agent SDK subagent orchestration production rules"
  - "Claude Code Agent SDK subagent orchestration rollout"
  - "Agent SDK subagent orchestration troubleshooting"
readingTime: 9
difficultyScore: 82
...
This capability pack is grounded in Claude Code agent-sdk/subagents, sub-agents, overview, and workflows documentation
...
- **Claude Code / Claude**: use as an Agent Skill when preparing Agent SDK subagent orchestration
...
- **Codex, Cursor, Windsurf, and Generic AGENTS workflows**: use the workflow as a
  deterministic checklist for Agent SDK subagent orchestration evaluations on Claude Code projects.
...
requests for Claude Agent SDK subagent orchestration, Agent SDK subagent orchestration, and Claude Code capability pack workflows. Official docs describe the feature directly, but
