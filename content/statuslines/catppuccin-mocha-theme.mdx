...
installable: true
usageSnippet: " claude-sonnet-4.5   ~/projects   main   12,450 "
copySnippet: |-
  {
    "statusLine": {
      "type": "command",
...
prerequisites:
  ...
  - >-
    ...
    // defaults)
  - >-
    Terminal with 256-color mode support (required for accurate Catppuccin Mocha
    palette reproduction)
  - >-
    Nerd Font installed and configured (required for Powerline separator glyphs:
    U+E0B0-U+E0B3)
