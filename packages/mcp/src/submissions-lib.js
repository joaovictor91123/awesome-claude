/**
 * Pure MCP submission draft helpers.
 *
 * Field normalization, spec validation, PR draft builders, duplicate search,
 * and category guidance live here. Nothing touches the network — given the
 * same submission fields the output is deterministic.
 *
