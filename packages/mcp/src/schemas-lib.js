/**
 * Pure MCP tool input/output Zod schemas.
 *
 * Validation schemas for every HeyClaude MCP tool argument surface live here.
 * The public surface (`schemas.js`) re-exports everything below so existing
 * `@heyclaude/mcp` imports stay unchanged.
 */
import { z } from "zod";
...
export const TOOL_INPUT_SCHEMAS = {
  ...
  "entry.coverage": CompareEntryTrustInputSchema,
};
