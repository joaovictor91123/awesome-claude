/**
 * Pure content schema helpers.
 *
 * Heading extraction, structured field inference, SEO derivation, and category-
 * specific validation live here. Nothing in this module touches the network —
 * given the same frontmatter and body text the output is deterministic.
 *
 * The public surface (`content-schema.js` / `@heyclaude/registry/content-schema`)
