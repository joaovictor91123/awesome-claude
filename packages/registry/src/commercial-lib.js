/**
 * Pure commercial listing, lead, and placement helpers.
 *
 * This module holds the deterministic validation and lifecycle layer used for
 * listing leads, paid job publication gates, public job exposure checks, source
 * lifecycle transitions, placement ranking, and renewal reminders. Nothing here
 * touches the filesystem or network — given the same inputs the output is
 * byte-stable.
 *
...
export function hasHttpsUrl(value) {
