/**
 * Pure trust posture and install-risk helpers.
 *
 * This module derives factual trust reasons, severity summaries, and install-risk
 * verdicts from registry entry metadata. Nothing here touches the network — given
 * the same entry fields the output is deterministic.
 *
 * The public surface (`trust.ts` / `@/lib/trust`) re-exports everything below so
