/**
 * Job admin D1 helpers.
 *
 * Schema checks, admin queries, upserts, and state transitions for job listings.
 * The public surface (`job-admin.ts` / `@/lib/job-admin`) re-exports everything
